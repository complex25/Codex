...
In continuous mode, press `Ctrl+C` to stop gracefully.
...
- If no article is written, the bot now prints a summary showing how many sources were fetched, failed, or skipped as already seen.
